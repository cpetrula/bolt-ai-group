...
const { CreateAppointmentData,
  ...
  AppointmentStatus, } = require('./appointment.model');
const { checkAvailability,
  calculateEndTime, } = require('./availability.service');
const { timeToMinutes,
  timeRangesOverlap,
 ...
 */
const getAppointmentById = async (tenantId, appointmentId) => {
...
const updateAppointment = async (
  ...
  if (employeeId || serviceId || appointmentDate || startTime || addonIds) {
    ...
    const newAddonIds = addonIds !== undefined ? addonIds : existingAppointment.addons.map((a) => a.addonId);
 ...
 */
const deleteAppointment = async (tenantId, appointmentId) => {
  // Verify appointment exists and belongs to tenant
...
module.exports = { getAppointments, getAppointmentById, createAppointment, updateAppointment, cancelAppointment, deleteAppointment };
