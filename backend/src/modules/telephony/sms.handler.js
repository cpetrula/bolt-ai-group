...
const { NotificationType, NotificationStatus } = require('@prisma/client');
...
module.exports = { handleIncomingSMS, sendCustomerNotification, sendEmployeeNotification, sendAppointmentConfirmation, sendAppointmentReminder };
